...
public final class ProjectorScreen extends HandledScreen<ProjectorScreenHandler> {
	...
	protected void init() {
		...
		mButtonExport = new ScreenTexturedButtonWidget(leftPos + 149, topPos + 7, 18, 19, 179, 33, GUI_TEXTURE, button -> {
			this.sendExport();
		});
	...
	protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
		context.drawTexture(GUI_TEXTURE, (width - imageWidth) / 2, (height - imageHeight) / 2, 0, 0, imageWidth, imageHeight);
	}
	...
	protected void drawForeground(DrawContext ctx, int mouseX, int mouseY) {
		...
		if (alpha > 0) {
			...
			ctx.drawTexture(GUI_TEXTURE, 38, 131, 180, 194, 10, 10);
			ctx.drawTexture(GUI_TEXTURE, 82, 159, 180, 194, 17, 17);
		}

		RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
		ctx.drawTexture(GUI_TEXTURE, 82, 159, 202, 194 - mRotation.ordinal() * 20, 17, 17);
	...
	public static class ScreenTexturedButtonWidget extends ButtonWidget {
		...
		public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
			context.drawTexture(this.texture, this.getX(), this.getY(), this.u, this.v, this.width, this.height);
		}
