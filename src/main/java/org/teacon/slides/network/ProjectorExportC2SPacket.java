...
public class ProjectorExportC2SPacket {
    ...
    private ItemStack getImageItem() {
        ...
        itemStack.setSubNbt("from_id", NbtByte.of(this.mFromID));
        itemStack.setSubNbt("location", NbtString.of(this.mLocation));
        return itemStack;
    }
        ...
        minecraftServer.execute(() -> {
            if (ProjectorBlock.hasPermission(serverPlayer)) {
                ...
                if (bl && itemStack.isEmpty()) {
                    ...
                    serverPlayer.getServerWorld().playSound(null, serverPlayer.getX(), serverPlayer.getY(), serverPlayer.getZ(), SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.PLAYERS, 0.2F, ((serverPlayer.getRandom().nextFloat() - serverPlayer.getRandom().nextFloat()) * 0.7F + 1.0F) * 2.0F);
