...
public abstract class Slide implements AutoCloseable {
	...
	public static final class Icon extends Slide {
		...
		private static final Identifier
				BACKGROUND = Identifier.of(Slideshow.ID, "textures/gui/slide_default.png"),
				ICON_EMPTY = Identifier.of(Slideshow.ID, "textures/gui/slide_icon_empty.png"),
				ICON_FAILED = Identifier.of(Slideshow.ID, "textures/gui/slide_icon_failed.png"),
				ICON_LOADING = Identifier.of(Slideshow.ID, "textures/gui/slide_icon_loading.png");
		...
		private void renderBackground(@NotNull VertexConsumerProvider source, Matrix4f matrix, MatrixStack.Entry normal,
									  int alpha, int light, int xSize, int ySize, boolean front, boolean back) {
